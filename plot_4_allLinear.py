...
torch.save(a_map_train, "train_tensor_4.pt")
torch.save(a_map_test, "test_tensor_4.pt")
...
np.save('pred_ds_4.npy', pred_ds)
np.save('real_ds_4.npy', real_ds)
np.save('pred_te_4.npy', pred_te)
np.save('real_te_4.npy', real_te)

trainloss4 = np.array(t_losses)
testloss4 = np.array(v_losses)
np.save('trainloss4.npy', trainloss4)
np.save('testloss4.npy', testloss4)
