...
torch.save(a_map_train, "train_tensor_2.pt")
torch.save(a_map_test, "test_tensor_2.pt")

fig,ax = plt.subplots(1, 2)
a = ax[0].imshow(a_map_train.detach().cpu()/500,vmin=-1,vmax=1,origin='lower')
#b = ax[0][1].imshow(a_map_train2.detach().cpu()/2,vmin=-1,vmax=1,origin='1ower')
c = ax[1].imshow(a_map_test.detach().cpu()/500,vmin=-1,vmax=1,origin='lower')
#d = ax[1][1].imshow(a_map_test2.detach().cpu()/2,vmin=-1,vmax=1,origin='1ower')
...
np.save('pred_ds_2.npy', pred_ds)
np.save('real_ds_2.npy', real_ds)
np.save('pred_te_2.npy', pred_te)
np.save('real_te_2.npy', real_te)

trainloss2 = np.array(t_losses)
testloss2 = np.array(v_losses)
...
#     plt.plot(seq_pred, label ='Pred train 2')
#     plt.plot(seq_real, label ='Real train 2')
#     plt.plot(te_pred, label ='Pred test 2')
#     plt.plot(te_real, label ='Real test 2')
#     plt.legend()
#     plt.show()
#     plt.savefig('legend_2'+ i + '.png')