...
### NO 0, NO ADD ORIGINAL, WITH LAYERNORM, WITHOUT FORWARD LINEAR
...
torch.save(a_map_train, "train_tensor_1.pt")
torch.save(a_map_test,'test_tensor_1.pt')
...
np.save('pred_ds_1.npy', pred_ds)
np.save('real_ds_1.npy', real_ds)
np.save('pred_te_1.npy', pred_te)
np.save('real_te_1.npy', real_te)

trainloss1 = np.array(t_losses)
testloss1 = np.array(v_losses)
np.save('trainloss1.npy', trainloss1)
np.save('testloss1.npy', testloss1)